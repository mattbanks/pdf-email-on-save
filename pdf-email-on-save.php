 ...
 * @TODO:
 *
 * - replace `class-pdf-email-on-save.php` with the name of the plugin's class file
 *
 */
 ...
 * @TODO:
 *
 * - replace `class-pdf-email-on-save-admin.php` with the name of the plugin's admin file
 * - replace Plugin_Name_Admin with the name of the class defined in
 *   `class-pdf-email-on-save-admin.php`
 *
